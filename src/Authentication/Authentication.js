...
const EyeIcon = ({ visible, toggleVisibility }) => {
    return (
        <IconWrapper onClick={toggleVisibility}>
            {visible ? <i className="fa fa-eye-slash"></i> : <i className="fa fa-eye"></i>}
        </IconWrapper>
    );
};
...
export function Authentication() {
    ...
    const handleSignUps = async (e) => {
        ...
        if(userType==="interviewer" && companyName==="candidate") alert("please select company name");
        else {
                ...
                <Components.Container>
                    <Components.SignUpContainer signinIn={signIn}>
                        <Components.Form>
                            ...
                            <Components.FormGroup>
                                ...
                                <Components.Input type='text' id="name" placeholder='Name' onChange={handleNameChange}/>
                            </Components.FormGroup>
                            <Components.FormGroup>
                                <Components.Label htmlFor="email">Email Address</Components.Label>
                                <Components.Input type='email' id="email" autoComplete={"off"} placeholder='Eg. developer.0208@gmail.cp,' onChange={handleEmailChange}/>
                            </Components.FormGroup>
                            <Components.FormGroup>
                                ...
                                />
                                <EyeIcon visible={showPassword} toggleVisibility={togglePasswordVisibility} />
                            </Components.FormGroup>
                            <Components.FormGroup>
                                <Components.Label htmlFor="confirm-password">Confirm Password</Components.Label>
                                <Components.Input
                                    type='password'
                                    id="confirm-password"
                            ...
                            <Components.FormGroup>
                                ...
                                <Components.RadioContainer>
                                    ...
                                    />
                                    <Components.RadioLabel htmlFor="interviewer">Interviewer</Components.RadioLabel>
                                    <Components.RadioInput
                                        type="radio"
                                        id="candidate"
                                        name="userType"
                                        ...
                                        onChange={handleUserTypeChange}
                                    />
                                    <Components.RadioLabel htmlFor="candidate">Candidate</Components.RadioLabel>
                                </Components.RadioContainer>
                                {userType === "interviewer" && ( // Render text field conditionally
                                    <Components.FormGroup>
                                        <Components.Label htmlFor="companyName">Company Name</Components.Label>
                                        <Components.Input
                                            type="text"
                                            id="companyName"
                                            value={companyName}
                            ...
                            <Components.Button onClick={handleSignUps}>Sign Up</Components.Button>
                        </Components.Form>
                    ...
                    <Components.SignInContainer signinIn={signIn}>
                        <Components.Form>
                            ...
                            <Components.FormGroup>
                                <Components.Label htmlFor="signin-email">Email</Components.Label>
                                <Components.Input type='email' id="signin-email" placeholder='Email' onChange={handleEmailChange}/>
                            </Components.FormGroup>
                            <Components.FormGroup>
                                <Components.Label htmlFor="signin-password" >Password</Components.Label>
                                <Components.Input type='password' id="signin-password" placeholder='Password' onChange={handlePasswordChange}/>
                            </Components.FormGroup>
                        ...
                        <Components.Overlay signinIn={signIn}>
                            <Components.LeftOverlayPanel signinIn={signIn}>
                                ...
                                <Components.Paragraph>
                                    To keep connected with us, please login with your personal information. Your journey towards interview success continues here.
                                </Components.Paragraph>
                            ...
                            <Components.RightOverlayPanel signinIn={signIn}>
                                ...
                                <Components.Paragraph>
                                    Enter your  details and start your journey towards interview success with us. Let's take the first step together.
                                </Components.Paragraph>
